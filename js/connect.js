window.onload = function () {
  ...
  setTimeout(() => {
    ...
    if (isDark) {
      ...
      this.document.getElementsByClassName("btn")[0].style.background =
        "rgba(255,255,255,0.1)";
      this.document.getElementsByClassName("btn")[0].style.color = "#3F97E9 ";
    }
    this.document.getElementById("alertContainer").style.cssText =
      "display:block";
    this.document.getElementById("progressContainer").style.cssText =
      "display:none";
  }, 30 * 1000);
...
function setDarkMode() {
  ...
  if (isDark) {
    this.document.getElementsByClassName(
      "connect-content"
    )[0].style.background = "#000000";
    this.document.getElementById("app").style.background = "#000000";
    this.document.getElementsByClassName("detail")[0].style.color =
      "rgba(255,255,255,0.86)";
    this.document.getElementsByClassName("failConnect")[0].style.color =
      "rgba(255,255,255,0.86)";
    this.document.getElementsByClassName("progress")[0].style.color =
      "rgba(255,255,255,0.86)";
    this.document.getElementsByClassName("progressDes")[0].style.color =
  ...
  if (data.deviceId === deviceId) {
    ...
    if (data.advertisData) {
      ...
      advertisData = advertisData
        .slice(advertisData.length - 13, advertisData.length - 1)
        .toLocaleUpperCase();
...
function getMacByRead() {
  ...
  window.hilink.createBLEConnection(deviceId);
  window.hilink.onBLEConnectionStateChange(
    "onIOSBLEConnectionStateChangeCallback"
  );
...
function internationalizes() {
  ...
  if (this.currentLanguage !== "zh-CN") {
    this.document.getElementsByClassName("progressDes")[0].innerHTML =
      "Connecting…";
    this.document.getElementsByClassName("failConnect")[0].innerHTML =
      "Unable to connect";
    this.document.getElementsByClassName("details")[0].innerHTML =
      "While connecting, make sure:";
    this.document.getElementsByClassName("details")[1].innerHTML =
      "1.The phone's Bluetooth is enabled.";
    this.document.getElementsByClassName("details")[2].innerHTML =
      "2.The device is within 5 meters of the phone.";
    this.document.getElementsByClassName("details")[3].innerHTML =
      "3.The phone is connected to the Internet.";
    this.document.getElementsByClassName("details")[4].innerHTML =
      "4.The device is not paired with the current account before.";
